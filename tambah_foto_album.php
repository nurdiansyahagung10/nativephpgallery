      ...
      <div class="row row-cols-5">
        ...
        while ($foto = mysqli_fetch_assoc($query)) {
          if ($foto['albumid'] != $albumid) {
            $hitungan++;
            ?>
            <label for="idfoto<?= $hitungan ?>" style="max-height: 200px; cursor: pointer;" class='p-3  overflow-hidden'>
              <div class="position-relative  " style="padding-bottom: 100% ; ">
                ...
                <div class="w-100 d-flex align-items-center img-opsi  justify-content-center h-100 position-absolute"
                  style="background-color: rgba(0, 0, 0, 0.5); ">
                  <div class="">
                    <div><span class="fs-5 text-white"> </span><input type="checkbox" class="form-check"
                        name="idfoto<?= $hitungan ?>" value="<?= $foto['fotoid'] ?>" id="idfoto<?= $hitungan ?>">
                    </div>
                  </div>
                </div>
              </div>
