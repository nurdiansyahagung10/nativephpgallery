...
<body>
  <div class="container-xxl">
    ...
    <div class="container-xxl">
        <form class="d-flex flex-column" action="proses_registrasi.php" method="post">
            ...
            <input class="form-control my-2" type="email" name="email" placeholder="email" id="">
            <input class="form-control my-2" type="text" name="nama_depan" placeholder="nama_depan" id="">
            <input class="form-control my-2" type="text" name="nama_belakang" placeholder="nama_belakang" id="">
            <label for="">alamat</label><textarea class="form-control my-2" name="alamat" id="" cols="30" rows="10"></textarea>
            <button class='my-2 btn btn-danger'>registrasi</button>
            <div>
